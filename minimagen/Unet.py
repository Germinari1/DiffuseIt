...
class Unet(nn.Module):
    ...
    def forward(
        ...
        :param lowres_noise_times: Time to noise to for low-res `noise conditioning augmentation 
            Shape (b,).
        ...
        :param cond_drop_prob: Probability of dropping conditioning info for `classifier-free guidance . Generally in
            the range [0.1, 0.2].
    ...
    def _text_condition(
        ...
        :param cond_drop_prob: Probability of conditional dropout for `classifier-free guidance 
